...
public class orgain extends Application {
  public class start {
...
private int s=0;
  ...
  VBox rr=new VBox(f,pan);
    ...
    b3.setStyle(
            "-fx-background-color:#ffd700;"+         //ÉèÖÃ±³¾°ÑÕÉ«
                    "-fx-background-radius:20;"+     //ÉèÖÃ±³¾°Ô²½Ç
                    "-fx-text-fill:#000000;"+        //ÉèÖÃ×ÖÌåÑÕÉ«
    ...
    VBox root1 = new VBox(rr,pane2,pane5,pane6,pane1111);
